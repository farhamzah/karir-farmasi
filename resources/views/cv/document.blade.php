...
<head>
    ...
    <style>
        .cv-09{--ink:#133d31!important;--muted:#5b7066!important;--accent:#1b6b4e!important;--soft:#edf4ef!important;background:radial-gradient(circle at 96% 2%,#e2eee5,transparent 30%),#fffdf8!important}.cv-09:before{height:2.6mm!important;background:linear-gradient(90deg,#174c39,#3b8669,#bc9457)!important}.cv-09 .identity{padding:6mm;border:0;border-radius:3mm;background:linear-gradient(110deg,#e4eee6 0 28%,rgba(255,255,255,.86) 28%)}.cv-09 .photo{width:31mm;height:38mm;border-radius:2mm;object-position:center 18%}.cv-09 .kicker{color:#9a6849}.cv-09 h1{color:#143c31;font-size:29pt}.cv-09 h2{color:#315d4e;font-family:Georgia,serif}.cv-09 .sections{grid-template-columns:1fr 1fr;gap:4mm}.cv-09 .summary,.cv-09 .experience,.cv-09 .projects,.cv-09 .publications{grid-column:1/-1}.cv-09 section{padding:3mm;border:.25mm solid #dbe5de;border-radius:2.5mm;background:rgba(255,255,255,.9)}.cv-09 .section-heading span{border-radius:1.5mm;background:#1b6b4e}.cv-09 h3{color:#173f32;font-family:Georgia,serif;letter-spacing:.08em}.cv-09 .item{border-color:#e5ebe7}.cv-09 .links a{border:0;border-radius:1.2mm;background:#e4f0e8;color:#165e45}
        .cv-10{--ink:#24372e!important;--muted:#6e7068!important;--accent:#856f3c!important;--soft:#f2eee3!important;padding:9mm;background:radial-gradient(circle at 96% 3%,#e8e2d2,transparent 25%),#fffdf7!important;font-family:Georgia,serif}.cv-10:before{height:1.2mm!important;background:linear-gradient(90deg,#263f32,#9c8147,#263f32)!important}.cv-10 .identity{padding:6mm;border:.25mm solid #d8ceb4;border-radius:2mm;background:linear-gradient(100deg,#f4f0e5 0 31%,rgba(255,255,255,.84) 31%)}.cv-10 .photo{width:32mm;height:39mm;border:.6mm solid #bba56d;border-radius:1.5mm;object-position:center 16%}.cv-10 .kicker{color:#94783e}.cv-10 h1{color:#1c2d25;font-size:28pt;font-weight:500}.cv-10 h2{color:#4b5a51;font:italic 9.5pt/1.4 Georgia,serif}.cv-10 .contact{color:#5f685f}.cv-10 .contact i{border:1px solid #bca96f;background:#fffdf7;color:#725e30}.cv-10 .sections{grid-template-columns:1fr 1fr 1fr;gap:3mm}.cv-10 .summary,.cv-10 .experience,.cv-10 .projects,.cv-10 .publications{grid-column:span 2}.cv-10 section{padding:3mm;border:.25mm solid #ded5c0;border-radius:2mm;background:rgba(255,255,255,.88)}.cv-10 .section-heading{border-color:#c8b88f}.cv-10 .section-heading span{border-radius:50%;background:#314f3d}.cv-10 h3{color:#293c32;font-family:Georgia,serif;letter-spacing:.08em}.cv-10 .item{border-color:#ebe5d7}.cv-10 .links a{border:.25mm solid #cdbc92;border-radius:1mm;background:#f8f3e7;color:#584923}
        .cv-11{--ink:#20372d!important;--muted:#626b63!important;--accent:#9b7e40!important;--soft:#f4eee0!important;padding:8mm;background:radial-gradient(circle at 94% 4%,#e5decb,transparent 27%),#fffaf0!important;font-family:Georgia,serif}.cv-11:before{height:1.4mm!important;background:linear-gradient(90deg,#1d4636,#ad8f50,#1d4636)!important}.cv-11 .identity{padding:6mm;border:.25mm solid #d8cbae;border-radius:2mm;background:linear-gradient(102deg,#f1eadb 0 35%,rgba(255,255,255,.9) 35%)}.cv-11 .photo{width:34mm;height:41mm;border:.7mm solid #b99b5d;border-radius:1mm;object-position:center 17%}.cv-11 .kicker{color:#9c7d40}.cv-11 h1{color:#172a21;font-size:29pt;font-weight:500}.cv-11 h2{color:#405248;font:italic 9.5pt/1.4 Georgia,serif}.cv-11 .contact{color:#59655d}.cv-11 .contact i{border:1px solid #bca66f;background:#fffaf0;color:#705a2c}.cv-11 .sections{grid-template-columns:1.1fr 1.1fr .8fr;gap:3mm}.cv-11 .summary,.cv-11 .experience,.cv-11 .projects,.cv-11 .publications{grid-column:span 2}.cv-11 section{padding:3mm;border:.25mm solid #ddd1b6;border-radius:1.5mm;background:rgba(255,255,255,.84)}.cv-11 .section-heading{border-color:#c4ad78}.cv-11 .section-heading span{border-radius:50%;background:#244b3a}.cv-11 h3{color:#263c31;font-family:Georgia,serif;letter-spacing:.08em}.cv-11 .item{border-color:#e8dfcc}.cv-11 .links a{border:.25mm solid #c7ae74;border-radius:1mm;background:#fbf4e3;color:#54431f}
        @page{size:A4;margin:10mm}@page cv07{size:A4;margin:0}@page cv08{size:A4;margin:0}*{box-sizing:border-box}html,body{margin:0;color:#1c3028;font-family:Arial,sans-serif;print-color-adjust:exact;-webkit-print-color-adjust:exact}body{overflow-wrap:anywhere}
        ...
        .cv-01 .experience-organization,.cv-02 .experience-organization,.cv-03 .experience-organization,.cv-04 .experience-organization,.cv-05 .experience-organization{margin:0 0 .4mm;color:#43594e;font-size:7.6pt;line-height:1.35}.cv-01 .experience-period,.cv-02 .experience-period,.cv-03 .experience-period,.cv-04 .experience-period,.cv-05 .experience-period{margin:0 0 1.1mm;color:var(--accent);font-size:6.5pt;font-weight:700;letter-spacing:.025em}.cv-01 .summary .description,.cv-02 .summary .description,.cv-03 .summary .description,.cv-04 .summary .description,.cv-05 .summary .description{font-style:normal}.cv-01 .experience .item,.cv-02 .experience .item,.cv-03 .experience .item,.cv-04 .experience .item,.cv-05 .experience .item{padding-bottom:2.6mm}.cv-01 .experience h4,.cv-02 .experience h4,.cv-03 .experience h4,.cv-04 .experience h4,.cv-05 .experience h4{margin-bottom:.8mm}
        .cv-01 .description,.cv-02 .description,.cv-03 .description,.cv-04 .description,.cv-05 .description{font-size:8pt;line-height:1.5}.cv-01 .meta span,.cv-02 .meta span,.cv-03 .meta span,.cv-04 .meta span,.cv-05 .meta span{font-size:7.2pt;line-height:1.45}.cv-01 .summary .description,.cv-02 .summary .description,.cv-03 .summary .description,.cv-04 .summary .description,.cv-05 .summary .description{font-size:8.2pt;line-height:1.55}
        ...
        .cv-08{--wine:#621b23;--gold:#caa46c;page:cv08;display:flex;flex-direction:column;min-height:297mm;padding:0;background:#fffaf3;color:#302624;font-family:Georgia,serif}.cv-08:before{display:none}.burgundy-hero{min-height:60mm;display:grid;grid-template-columns:51mm minmax(0,1fr) 27mm;gap:6mm;padding:4mm 6mm;background:radial-gradient(circle at 80% 15%,#792b31,#57171e 58%,#3f1115);color:#fff7e9}.burgundy-photo{height:52mm;display:grid;place-items:center;border:1mm solid #d6b776;border-radius:2mm;overflow:hidden;background:#e8ded0;color:#65222a;font:700 22pt Georgia,serif}.burgundy-photo img{width:100%;height:100%;object-fit:cover;object-position:center top}.burgundy-identity{padding-top:2mm}.burgundy-identity>p{margin:0;color:#e2c087;font:700 5.5pt Arial,sans-serif;letter-spacing:.3em}.burgundy-identity>small{display:block;margin-top:1.5mm;padding-bottom:2.5mm;border-bottom:.25mm solid #d4ab6e;color:#f0dfc0;font:650 5pt Arial,sans-serif;letter-spacing:.22em}.burgundy-identity h1{margin:4mm 0 1.5mm;color:#fffaf1;font-size:25pt}.burgundy-identity h2{max-width:none;margin:0;color:#fff2dd;font:500 7pt/1.35 Arial,sans-serif}.burgundy-identity blockquote{margin:5mm 0 0;color:#ead8bc;font:italic 9pt/1.35 Georgia,serif}.burgundy-hero aside{color:#ead1aa;font:650 4.2pt/1.7 Arial,sans-serif;letter-spacing:.24em;text-align:center}.burgundy-hero aside span{display:block;margin-top:4mm;font-size:26pt}.burgundy-contact{display:grid;grid-template-columns:1fr 1.1fr;gap:4mm;padding:3mm 6mm;border-bottom:.25mm solid #9a6d60}.burgundy-contact>div{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1.5mm 3mm;padding-right:3mm;border-right:.25mm solid #b99384;font:5.5pt/1.3 Arial,sans-serif}.burgundy-contact span{display:flex;align-items:center;gap:1.5mm}.burgundy-contact span i{width:5mm;height:5mm;display:grid;place-items:center;flex:none;border-radius:50%;background:var(--wine);color:#fff;font-style:normal}.burgundy-contact nav{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1.3mm}.burgundy-contact nav a{display:flex;align-items:center;justify-content:center;padding:1.3mm;border:.25mm solid #a77b74;border-radius:1mm;color:#542027;font:650 4.8pt Arial,sans-serif}.burgundy-contact nav a:first-child,.burgundy-contact nav a:nth-child(2){background:var(--wine);color:#fff7eb}.burgundy-body{display:grid;grid-template-columns:1fr 1fr;padding:2mm 6mm 0}.burgundy-column{min-width:0;padding-right:4mm}.burgundy-right{padding:0 0 0 4mm;border-left:.25mm solid #cdb9ad}.burgundy-section{padding:2mm 0}.burgundy-heading{display:flex;align-items:center;gap:2mm;margin-bottom:1.5mm}.burgundy-heading:after{content:'';height:.25mm;flex:1;background:#8c4a4d}.burgundy-heading span{width:6.5mm;height:6.5mm;display:grid;place-items:center;flex:none;border-radius:50%;background:var(--wine);color:#fff;font:700 4pt Arial,sans-serif}.burgundy-heading h3{padding:0;color:#5e2026;font:700 10pt Georgia,serif;letter-spacing:.06em}.burgundy-items{display:grid;gap:1mm}.burgundy-item{position:relative;padding:0 0 1.3mm 9mm;break-inside:avoid}.burgundy-item:before{content:'•';position:absolute;left:3mm;color:var(--wine)}.burgundy-item h4{margin:0 0 .5mm;font-size:7.2pt}.burgundy-item .meta{gap:.5mm 1.5mm}.burgundy-item .meta span{font-size:5.2pt}.burgundy-item .meta small{color:#8b3a3d;font-size:4pt}.burgundy-item .description{margin-top:.5mm;font-size:6pt;line-height:1.35}.burgundy-item .links a{border:.25mm solid #a98279;background:#fff;color:#64242b;font-size:4.5pt}.burgundy-section.summary .burgundy-item{padding-left:0}.burgundy-section.summary .burgundy-item:before{display:none}.burgundy-section.summary .description{font-size:7pt}.burgundy-section.skills .burgundy-items{grid-template-columns:1fr 1fr}.burgundy-section.skills .burgundy-item{padding:2mm;border-radius:2mm;background:#f0ece7}.burgundy-bottom{display:grid;grid-template-columns:1fr 1fr;gap:5mm;margin:0 6mm;padding-top:1mm;border-top:.25mm solid #9e756b}.burgundy-bottom .burgundy-items{display:flex;flex-wrap:wrap}.burgundy-bottom .burgundy-item{flex:1 1 25mm;padding:1.5mm 2mm;border-radius:8mm;background:#ece7e1}.burgundy-bottom .burgundy-item:before{display:none}.burgundy-footer{min-height:14mm;display:flex;align-items:center;gap:5mm;margin-top:auto;padding:3mm 8mm;background:linear-gradient(100deg,#431216,#681f26,#431216);color:#e7c89a}.burgundy-footer i{height:.25mm;flex:1;background:#cea96e}.burgundy-footer em{font:italic 8pt Georgia,serif;text-align:center}
    </style>
</head>
<body>
@php
    ...
    $burgundyLeftKeys = ['summary', 'education', 'experience'];
    $burgundyRightKeys = ['skills', 'certifications', 'event_certificates', 'events', 'organizations', 'projects', 'publications'];
    $burgundyBottomKeys = ['languages', 'preferences'];
    $impactLinks = collect([
...
@elseif(($cv['template']['key'] ?? '') === 'cv-08')
<main class="paper cv-08">
    <header class="burgundy-hero">
        <div class="burgundy-photo">@if(($cv['has_photo'] ?? false) && $photoDataUri)<img src="{{ $photoDataUri }}" alt="">@else{{ $initials }}@endif</div>
        <div class="burgundy-identity"><p>ALUMNI FARMASI</p><small>ILMU · INTEGRITAS · DAMPAK NYATA</small><h1>{{ $cv['professional_name'] }}</h1>@if($cv['headline'] ?? null)<h2>{{ $cv['headline'] }}</h2>@endif<blockquote>“Farmasi untuk kehidupan yang lebih baik.”</blockquote></div>
        <aside>OBAT<br>PASIEN<br>MASA DEPAN<span>❧</span></aside>
    </header>
    <div class="burgundy-contact">
        <div>@foreach(array_slice($contacts, 0, 3) as $contact)<span><i>{{ $contact['icon'] }}</i>@if($contact['href'])<a href="{{ $contact['href'] }}">{{ $contact['label'] }}</a>@else{{ $contact['label'] }}@endif</span>@endforeach</div>
        @if($impactLinks->isNotEmpty())<nav>@foreach($impactLinks as $link)<a href="{{ $link['href'] }}">{{ $link['label'] }}</a>@endforeach</nav>@endif
    </div>
    <div class="burgundy-body">
        @foreach(['burgundy-left' => $burgundyLeftKeys, 'burgundy-right' => $burgundyRightKeys] as $columnClass => $sectionKeys)
            <div class="burgundy-column {{ $columnClass }}">
                @foreach($sectionKeys as $sectionKey)
                    @php $section = $sectionsByKey->get($sectionKey); @endphp
                    @continue(! $section || empty($section['items']))
                    @php $primary = $primaryFields[$section['key']] ?? ['title', 'name']; @endphp
                    <section class="burgundy-section {{ $section['key'] }}"><div class="burgundy-heading"><span>{{ str_pad((string) $loop->iteration, 2, '0', STR_PAD_LEFT) }}</span><h3>{{ $section['title'] }}</h3></div><div class="burgundy-items">
                        @foreach($section['items'] as $item)
                            @php
                                $title = collect($primary)->map(fn ($field) => $item[$field] ?? null)->filter()->implode(' · ');
                                $description = $item['description'] ?? null;
                                $links = collect(['credential_url' => 'Sertifikat', 'project_url' => 'Lihat Portofolio', 'url' => 'Lihat Publikasi'])->filter(fn ($label, $field) => filled($item[$field] ?? null))->map(fn ($label, $field) => ['href' => $item[$field], 'label' => $field === 'credential_url' ? $credentialLabel($item) : $label]);
                                $metadata = collect($item)->reject(fn ($value, $field) => in_array($field, array_merge($primary, ['description', 'credential_url', 'project_url', 'url']), true) || $value === null || $value === '' || is_bool($value));
                            @endphp
                            <article class="burgundy-item">@if($title)<h4>{{ $title }}</h4>@endif @if($metadata->isNotEmpty())<div class="meta">@foreach($metadata as $field => $value)<span>@if($fieldLabels[$field] ?? null)<small>{{ $fieldLabels[$field] }}</small>@endif{{ $value }}</span>@endforeach</div>@endif @if($description)<p class="description">{{ $description }}</p>@endif @if($links->isNotEmpty())<div class="links">@foreach($links as $link)<a href="{{ $link['href'] }}">{{ $link['label'] }} ↗</a>@endforeach</div>@endif</article>
                        @endforeach
                    </div></section>
                @endforeach
            </div>
    ...
    <div class="burgundy-bottom">
        @foreach($burgundyBottomKeys as $sectionKey)
            @php $section = $sectionsByKey->get($sectionKey); @endphp
            @continue(! $section || empty($section['items']))
            @php $primary = $primaryFields[$section['key']] ?? ['title', 'name']; @endphp
            <section class="burgundy-section {{ $section['key'] }}"><div class="burgundy-heading"><span>{{ str_pad((string) $loop->iteration, 2, '0', STR_PAD_LEFT) }}</span><h3>{{ $section['title'] }}</h3></div><div class="burgundy-items">
                @foreach($section['items'] as $item)
                    @php $title = collect($primary)->map(fn ($field) => $item[$field] ?? null)->filter()->implode(' · '); $metadata = collect($item)->reject(fn ($value, $field) => in_array($field, array_merge($primary, ['description', 'credential_url', 'project_url', 'url']), true) || $value === null || $value === '' || is_bool($value)); @endphp
                    <article class="burgundy-item">@if($title)<h4>{{ $title }}</h4>@endif @if($metadata->isNotEmpty())<div class="meta">@foreach($metadata as $field => $value)<span>@if($fieldLabels[$field] ?? null)<small>{{ $fieldLabels[$field] }}</small>@endif{{ $value }}</span>@endforeach</div>@endif</article>
                @endforeach
            </div></section>
        @endforeach
    </div>
    <footer class="burgundy-footer"><i></i><em>“Kesehatan hari ini, harapan untuk esok yang lebih baik.”</em><i></i></footer>
</main>
                        ...
                        <section class="{{ $section['key'] }}"><div class="section-heading"><span>{{ str_pad((string)($sectionIndex+1),2,'0',STR_PAD_LEFT) }}</span><h3>{{ $section['title'] }}</h3></div><div class="items">
                            @foreach($section['items'] as $item)
                                @php
                                    ...
                                    $isExperience=$section['key']==='experience';
                                    $experience=$isExperience?$experienceDetails($item):null;
                                    $metadata=collect($item)->reject(fn($value,$field)=>in_array($field,array_merge($primary,['description','credential_url','project_url','url'],$isExperience?['type','organization','location','start_date','end_date','currently_active']:[]),true)||$value===null||$value===''||is_bool($value));
                                @endphp
                                <article class="item">@if($title)<h4>{{ $title }}</h4>@endif
                                    @if($experience && $experience['organization'])<p class="experience-organization">{{ $experience['organization'] }}</p>@endif
                                    @if($experience && $experience['period'])<p class="experience-period">{{ $experience['period'] }}</p>@endif
                                    @if($metadata->isNotEmpty())<div class="meta">@foreach($metadata as $field=>$value)<span>@if($fieldLabels[$field]??null)<small>{{ $fieldLabels[$field] }}</small>@endif{{ $value }}</span>@endforeach</div>@endif
                                    @if($description)<p class="description">{{ $description }}</p>@endif
                                    @if($links->isNotEmpty())<div class="links">@foreach($links as $link)<a href="{{ $link['href'] }}">{{ $link['label'] }} ↗</a>@endforeach</div>@endif
                                </article>
            ...
            <section class="{{ $section['key'] }}"><div class="section-heading"><span>{{ str_pad((string)($sectionIndex+1),2,'0',STR_PAD_LEFT) }}</span><h3>{{ $section['title'] }}</h3></div><div class="items">
                @foreach($section['items'] as $item)
                    @php
                        ...
                        $description=$item['description']??null;
                        $links=collect(['credential_url'=>'Sertifikat','project_url'=>'Lihat Portofolio','url'=>'Publikasi'])->filter(fn($label,$field)=>filled($item[$field]??null))->map(fn($label,$field)=>['href'=>$item[$field],'label'=>$field==='credential_url'?$credentialLabel($item):($field==='url'&&str_contains(strtolower($item[$field]),'scholar.google')?'Google Scholar':$label)]);
                        $isExperience=$section['key']==='experience'&&in_array($cv['template']['key']??'', ['cv-01','cv-02','cv-03','cv-04','cv-05'], true);
                        $experience=$isExperience?$experienceDetails($item):null;
                        $metadata=collect($item)->reject(fn($value,$field)=>in_array($field,array_merge($primary,['description','credential_url','project_url','url'],$isExperience?['type','organization','location','start_date','end_date','currently_active']:[]),true)||$value===null||$value===''||is_bool($value));
                    @endphp
                    <article class="item">@if($title)<h4>{{ $title }}</h4>@endif
