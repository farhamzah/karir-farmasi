...
export default function Edit({ profile }: { profile: Profile }) {
    ...
    const discoverability = useForm({
        ...
        visible_in_alumni_directory: profile.visible_in_alumni_directory,
    });
