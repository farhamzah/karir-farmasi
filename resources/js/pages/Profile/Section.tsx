...
type Field = { name: string; label: string; type: 'text' | 'number' | 'date' | 'url' | 'textarea' | 'select' | 'checkbox' | 'file'; required?: boolean; options?: string[] };
