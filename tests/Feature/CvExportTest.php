...
class CvExportTest extends TestCase
{
    ...
    public function test_private_pdf_uses_browser_renderer_for_all_five_templates_and_is_own_own_only(): void
    {
        ...
        $this->assertSame(['cv-01', 'cv-02', 'cv-03', 'cv-04', 'cv-05'], collect($renderer->snapshots)->pluck('template.key')->all());
