...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $templateId = DB::table('cv_templates')->insertGetId([
            'key' => 'cv-09',
            'name' => 'Botanical Web Portfolio',
            'description' => 'Website personal premium dengan hero editorial, navigasi anchor, kartu portfolio, dan CTA profesional.',
            'active' => true,
            'category' => 'web-portfolio',
            'base_template_key' => 'cv-09',
            'display_order' => 90,
            'created_at' => $now,
            'updated_at' => $now,
        ]);
    ...
    {
        $templateId = DB::table('cv_templates')->where('key', 'cv-09')->value('id');
        if ($templateId === null) {
            return;
        }
