...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $templateId = DB::table('cv_templates')->insertGetId([
            'key' => 'cv-10',
            'name' => 'Ivory Editorial Portfolio',
            'description' => 'Website portfolio editorial bernuansa ivory dan olive dengan hero personal, credential row, timeline, dan grid karya premium.',
            'active' => true,
            'category' => 'web-portfolio',
            'base_template_key' => 'cv-10',
            'display_order' => 100,
            'created_at' => $now,
            'updated_at' => $now,
        ]);
    ...
    {
        $templateId = DB::table('cv_templates')->where('key', 'cv-10')->value('id');
        if ($templateId === null) {
            return;
        }
